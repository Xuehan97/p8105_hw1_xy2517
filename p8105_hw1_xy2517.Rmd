...
The average bill_length is `r round(mean(penguins$bill_length_mm),0)`mm, 
average bill_depth is `r round(mean(penguins$bill_depth_mm),0)`mm, 
average flipper_length is `r round(mean(penguins$flipper_length_mm),0)`mm,
average body_mass is `r round(mean(penguins$body_mass_g),0)`g. 
